...
Rules
- Numbers come from `00-Meta/numbers-ledger.md` only. Never invent a figure.
- Client-facing copy follows `20-Brand/voice.md`.
- Anything outbound waits for the owner's approval.
